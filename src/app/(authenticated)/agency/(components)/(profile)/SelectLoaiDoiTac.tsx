...
export const SelectLoaiDoiTac = ({
  setLoaiDoiTacValue,
  loaiDoiTacValue,
}) => {
  const [selectedLoaiDoiTac, setSelectedLoaiDoiTac] = React.useState(new Set([]));
  ...
  {
    label: "Doanh nghiệp", value: "doanhnghiep"
  }];
    ...
    <div className='flex flex-col h-full gap-y-6'>
      <div className='flex flex-row gap-2'>
        <Select
          ...
          selectedKeys={loaiDoiTacValue ? [loaiDoiTacValue] : []}
          isInvalid={isLoaiDoiTacValid || !loaiDoiTacTouched ? false : true}
          errorMessage={
            isLoaiDoiTacValid || !loaiDoiTacTouched ? '' : 'Vui lòng chọn danh mục'
          }
